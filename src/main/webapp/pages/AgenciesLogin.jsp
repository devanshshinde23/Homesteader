...
<head>
    ...
    <title>Agency Login | Homesteader</title>
...
<c:if test="${not empty success}">
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="admin-card shadow-lg p-4">
            ...
            <h2 class="text-center text-success fw-bold mb-2">Agency Panel</h2>
            <p class="text-center text-muted mb-4">Login to access Agency dashboard</p>

            <!-- Login Form -->
            <form action="checkAgencyData" method="post">
