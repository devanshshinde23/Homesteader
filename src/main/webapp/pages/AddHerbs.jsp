				...
				<div class="card shadow-lg">
					...
					<div class="card-body p-4">
						...
						<form action="saveHerbs" method="post">
							...
							<!-- Herb Name -->
							<div class="mb-3">
								<label class="form-label">Herb Name</label> <input type="text"
									name="herbName" class="form-control"
									placeholder="Enter herb name" required>
							</div>
							...
							<!-- Quantity -->
							<div class="mb-3">
								<label class="form-label">Quantity (Kg)</label> <input
							...
							<!-- Price -->
							<div class="mb-3">
								<label class="form-label">Price (₹ per Kg)</label> <input
